...
from system.cloudtdms.utils.pandas_profiling.config import config
from system.cloudtdms.utils.pandas_profiling.model.describe import describe as describe_df
from system.cloudtdms.utils.pandas_profiling.model.messages import MessageType
from system.cloudtdms.utils.pandas_profiling.report import get_report_structure
from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.html.templates import (
    create_html_assets,
)
from system.cloudtdms.utils.pandas_profiling.serialize_report import SerializeReport
from system.cloudtdms.utils.pandas_profiling.utils.dataframe import hash_dataframe, rename_index
from system.cloudtdms.utils.pandas_profiling.utils.paths import get_config
...
class ProfileReport(SerializeReport, object):
    ...
    def _render_html(self):
        from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours import HTMLReport
    ...
    def _render_widgets(self):
        from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours import WidgetReport
    ...
    def to_notebook_iframe(self):
        ...
        from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.widget.notebook import (
            get_notebook_iframe,
        )
    ...
    def to_app(self):
        ...
        from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours import QtReport
        from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.qt.app import get_app
