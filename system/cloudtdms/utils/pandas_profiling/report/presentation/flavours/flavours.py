...
def get_html_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    ...
    from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.html import (
        HTMLHTML,
        HTMLCollapse,
        HTMLContainer,
        HTMLDuplicate,
...
def get_widget_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    ...
    from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.widget import (
        WidgetCollapse,
        WidgetContainer,
        WidgetDuplicate,
...
def get_qt_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    ...
    from system.cloudtdms.utils.pandas_profiling.report.presentation.flavours.qt import (
        QtCollapse,
        QtContainer,
        QtDuplicate,
        QtFrequencyTable,
