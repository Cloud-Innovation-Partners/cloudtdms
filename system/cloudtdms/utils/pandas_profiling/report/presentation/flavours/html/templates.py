...
from system.cloudtdms.utils.pandas_profiling.report.formatters import get_fmt_mapping

# Initializing Jinja
from system.cloudtdms.utils.pandas_profiling.utils.paths import get_html_template_path

# package_loader = PackageLoader(
#     "system.cloudtdms.utils.pandas_profiling", "system/cloudtdms/utils/pandas_profiling/report/presentation/flavours/html/templates"
# )

templates  = os.path.dirname(__file__)
templateLoader = jinja2.FileSystemLoader(searchpath=f"{templates}/templates")
jinja2_env = Environment(lstrip_blocks=True, trim_blocks=True, loader=templateLoader)
