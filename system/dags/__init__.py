...
output = template.render(
    data={
        'dag_id': str('profile_churn_modeling'),
        'frequency': 'once',
        'data_file' : 'Churn-Modeling'
    }
)
dag_file_path = f"{get_airflow_home()}/dags/profile_churn_modeling.py"
with open(dag_file_path, 'w') as f:
    f.write(output)

LoggingMixin().log.info(f"Creating DAG: profile_churn_modeling.py")
